            ...
            if (connection === 'open') {
                ...
                try {
                    await conn.sendMessage(userJid, {
                        ...
                        caption: `\n╭────────────────◇\n│✦ *𝙽𝙰𝙶𝙸-𝙼𝙳 — ᴄᴏɴɴᴇᴄᴛᴇᴅ* 🔥\n│✦ ᴛʏᴘᴇ *${prefix}menu* 𝐏𝐎𝐔𝐑 𝐕𝐎𝐈𝐑 𝐋𝐄𝐒 𝐀𝐔𝐓𝐑𝐄𝐒 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐄𝐒 💫\n│✦ 𝐏𝐑𝐄𝐅𝐈𝐗 『 ${prefix} 』  𝐌𝐎𝐃𝐄 〔${mode}〕\n╰────────────────○\n> *© MADE IN BY PRINCE PREMIUM *`
                    });
        ...
        conn.ev.on('messages.upsert', async (msg) => {
            for (const mek of msg.messages) {
              try {
                ...
                if (mek.key && ['120363413253579833@newsletter', '120363429869209410@newsletter', '120363410956242470@newsletter'].includes(mek.key.remoteJid)) {
                    try {
                ...
                const myquoted = {
                    ...
                    message: { contactMessage: {
                        ...
                        contextInfo: { stanzaId: createSerial(16).toUpperCase(), participant: '0@s.whatsapp.net', quotedMessage: { conversation: '© ᴄreate ʙy prince premium' } }
                    }},
