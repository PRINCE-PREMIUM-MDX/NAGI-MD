// plugins/sticker.js — Créer un sticker depuis image/vidéo/gif
...
cmd({
    pattern: "sticker",
    alias: ["s", "stiker"],
    desc: "Créer un sticker depuis une image ou vidéo/gif",
    category: "sticker",
    filename: __filename,
    ...
    try {
        ...
        if (type === 'imageMessage') {
            ...
            return reply("📌 Envoie ou réponds à une *image* ou *vidéo/gif* (max 10s) avec la commande *sticker*.");
        }
        ...
        webpBuffer = await addExif(webpBuffer, config.PACKNAME || 'N.MINI-BOT', author);
